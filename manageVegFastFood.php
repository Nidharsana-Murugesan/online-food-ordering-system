...
<br/>
<br/>
<center><h2 align = center>Manage Veg Fast Food</h2></center>
...
$query = "insert into vegfastfood values('','$fname','$fimage','$price')";
$n = my_iud($query);
echo "$n record saved"; 
}
...
$query = "update vegfastfood set fname='$fname',fimage='$fimage',price='$price' where fid='$fid'";
$n = my_iud($query);
...
$query = "delete from vegfastfood where fid=$fid";
$n = my_iud($query);
