...
<br/>
<br/>
<center><h2 align = center>Manage Pizza</h2></center>
...
$query = "insert into pizza values('','$fname','$fimage','$price')";
$n = my_iud($query);
echo "$n record saved"; 
}
...
$query = "update pizza set fname='$fname',fimage='$fimage',price='$price' where fid='$fid'";
$n = my_iud($query);
...
$query = "delete from pizza where fid=$fid";
$n = my_iud($query);
