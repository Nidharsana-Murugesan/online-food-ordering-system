...
<br/>
<br/>
<center><h2 align = center>Manage Indian</h2></center>
...
$query = "insert into indian values('','$fname','$fimage','$price')";
$n = my_iud($query);
echo "$n record saved"; 
}
...
$query = "update indian set fname='$fname',fimage='$fimage',price='$price' where fid='$fid'";
$n = my_iud($query);
...
$query = "delete from indian where fid=$fid";
$n = my_iud($query);
