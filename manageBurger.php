...
<br/>
<br/>
<center><h2 align = center>Manage Burger</h2></center>
...
$query = "insert into burger values('','$fname','$fimage','$price')";
$n = my_iud($query);
echo "$n record saved"; 
}
...
$query = "update burger set fname='$fname',fimage='$fimage',price='$price' where fid='$fid'";
$n = my_iud($query);
...
$query = "delete from burger where fid=$fid";
$n = my_iud($query);
