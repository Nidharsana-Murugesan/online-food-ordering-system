...
<br/>
<br/>
<center><h2 align = center>Manage Sandwich</h2></center>
...
$query = "insert into sandwich values('','$fname','$fimage','$price')";
$n = my_iud($query);
echo "$n record saved"; 
}
...
$query = "update sandwich set fname='$fname',fimage='$fimage',price='$price' where fid='$fid'";
$n = my_iud($query);
...
$query = "delete from sandwich where fid=$fid";
$n = my_iud($query);
