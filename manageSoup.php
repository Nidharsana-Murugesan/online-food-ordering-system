...
<br/>
<br/>
<center><h2 align = center>Manage Soup</h2></center>
...
$query = "insert into soup values('','$fname','$fimage','$price')";
$n = my_iud($query);
echo "$n record saved"; 
}
...
$query = "update soup set fname='$fname',fimage='$fimage',price='$price' where fid='$fid'";
$n = my_iud($query);
...
$query = "delete from soup where fid=$fid";
$n = my_iud($query);
