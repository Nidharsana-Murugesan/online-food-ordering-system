...
<br/>
<br/>
<center><h2 align = center>Manage NonVeg Fast Food</h2></center>
...
$query = "insert into nonvegfastfood values('','$fname','$fimage','$price')";
$n = my_iud($query);
echo "$n record saved"; 
}
...
$query = "update nonvegfastfood set fname='$fname',fimage='$fimage',price='$price' where fid='$fid'";
$n = my_iud($query);
...
$query = "delete from nonvegfastfood where fid=$fid";
$n = my_iud($query);
...
$query = "select * from nonvegfastfood";
$rs = my_select($query);
$n = mysql_num_rows($rs);
