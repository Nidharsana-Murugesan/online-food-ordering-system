...
<br/>
<br/>
<center><h2 align = center>NonVeg Fast Food</h2></center>
...
$fname = $_POST['fname'];
$query = "select * from nonvegfastfood where fname='$fname'";
$rs = my_select($query);
$n = mysql_num_rows($rs);
echo "<table align = center border = 1 width=100%>";
echo "<tr>";
...
$price1 = $_POST['price1'];
$price2 = $_POST['price2'];
$query = "select * from nonvegfastfood where price>='$price1' and price<='$price2'";
$rs = my_select($query);
$n = mysql_num_rows($rs);
echo "<table align = center border = 1 width=100%>";
echo "<tr>";
