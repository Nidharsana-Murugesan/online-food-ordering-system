...
<br/>
<br/>
<center><h2 align = center>Manage Ingredient</h2></center>
...
$query = "insert into ingredient values('','$rname','$rtype','$rimage','$ringredient','$rdescription')";
$n = my_iud($query);
echo "$n record saved"; 
}
...
$query = "update ingredient set rname='$rname',rtype='$rtype',rimage='$rimage',ringredient='$ringredient',rdescription='$rdescription' where rid='$rid'";
$n = my_iud($query);
...
$query = "delete from ingredient where rid=$rid";
$n = my_iud($query);
