...
<br/>
<br/>
<center><h2 align = center>Manage Chinese</h2></center>
...
$query = "insert into chinese values('','$fname','$fimage','$price')";
$n = my_iud($query);
echo "$n record saved"; 
}
...
$query = "update chinese set fname='$fname',fimage='$fimage',price='$price' where fid='$fid'";
$n = my_iud($query);
...
$query = "delete from chinese where fid=$fid";
$n = my_iud($query);
